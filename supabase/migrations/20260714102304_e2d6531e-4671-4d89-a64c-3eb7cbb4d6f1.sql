...
BEGIN
  ...
  UPDATE public.poker_wallets SET chips = 0, locked = 0;
END;
$$;

REVOKE ALL ON FUNCTION public.admin_reset_casino() FROM public, anon;
GRANT EXECUTE ON FUNCTION public.admin_reset_casino() TO authenticated;